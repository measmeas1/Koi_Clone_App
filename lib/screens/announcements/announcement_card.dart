...
class AnnouncementCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onCardPressed,
      child: (imageUrl.isNotEmpty && title.isNotEmpty && subtitle.isNotEmpty)
          ? Container(
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(imageUrl, height: 500, width: double.infinity, fit: BoxFit.cover),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 15, top: 15, right: 12),
                    child: Row(
          ...
          : Container(), // Render nothing if any data is missing
    );
  }
}
